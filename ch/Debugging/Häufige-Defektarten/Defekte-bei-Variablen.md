...
Der vorhergehende Code hierzu wird in den Aufgaben [PARTREF::Defekte-in-Ausdrücken] und 
[PARTREF::Anordnungsdefekte] besprochen.
...
[PARTREF::Defekte-in-Ausdrücken] und 
`check_card()` aus der Aufgabe [PARTREF::Anordnungsdefekte].
...
[NOTICE]
Falls Sie die Aufgaben [PARTREF::Defekte-in-Ausdrücken] und [PARTREF::Anordnungsdefekte] nicht 
