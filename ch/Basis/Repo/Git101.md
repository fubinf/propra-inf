...
- Auf Windows/WSL und in Debian/Ubuntu Linux:  
  ...
  In der Aufgabe [PARTREF::apt] befassen wir uns mit dem Kommando 'apt' genauer.
...
mit Jahr und Monat, in dem Ihre ProPra-Lehrveranstaltung _begann_, also beispielsweise "propra-2031-04".  
...
"Manage" auf. Darin den Eintrag "Members".  
Nun geht es weiter mit der Schaltfläche "Invite members" oben rechts.
Jetzt können wir (für jeden _Instructor_ einzeln) die oben als "gitaccount" gesehenen
...
ist meist sinnvoll, das in einem Unterverzeichnis der Art
`MeinKapitel/MeineGruppe/MeineTask/` zu tun.
