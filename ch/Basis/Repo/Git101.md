...
stage: alpha TODO_1_hüster Durchsicht und Ergänzung
timevalue: 1.0
difficulty: 1
...
anlegen.  
Besuchen Sie [https://git.imp.fu-berlin.de](https://git.imp.fu-berlin.de/) und melden Sie sich mit Ihren Zedat-Logindaten an.  
...
Nachdem erfolgreichen Klonen sollte jetzt ein Unterordner mit dem Namen unseres Projektes erstellt worden sein.
...
um unsere erste Änderung durchzuführen und danach zum Server hochzuladen.
